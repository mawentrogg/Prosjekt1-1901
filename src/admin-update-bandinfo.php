...
<html>
<head>
    <title>Oppdater nøkkelinformasjon for bandt</title>
...
<div style="margin: 0;height: 100%" class="flexBody">
    <div style="width:50%; " class="flexWrapper">
        <p class="insideMenuHeader">Admin//Oppdater nøkkelinformasjon for band</p>
        <div style="background-color:#353535; overflow-y: hidden;" class="flexWrapperInside">
            <form action="includes/update-bandinfo.inc.php" method="post">
                <label>Band-ID:</label>
                ...
                <input type="number" name="poprank">
                <label>Number of sales:</label>
                <input type="number" name="sales">
                <input type="submit" name="submit" value="Oppdater nøkkelinformasjon">
            </form>
        </div>
    </div>
</div>
