...
<html>
<head>
    <title>Oppdater konsertkostader</title>
...
<div style="margin: 0;height: 100%" class="flexBody">
    <div style="width:50%; " class="flexWrapper">
        <p class="insideMenuHeader">Admin//Oppdater konsertkostander</p>
        <div style="background-color:#353535; overflow-y: hidden;" class="flexWrapperInside">
            <form action="includes/update-concert-costs.inc.php" method="post">
                ...
                <label>Matkostnader:</label>
                <input type="number" name="food" min="0">
                <label>Tekniske kostnader:</label>
                <input type="number" name="technical" min="0">
                <label>Sikkerhetskostnader:</label>
                <input type="number" name="security" min="0">
                <label>Markedsføringskostnader</label>
                <input type="number" name="marketing" min="0">
